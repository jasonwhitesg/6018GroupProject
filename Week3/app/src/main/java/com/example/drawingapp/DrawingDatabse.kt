...
//
//    @Insert
//    suspend fun addDrawingData(drawingData: DrawingData)
//
//    @Query("SELECT * FROM drawing_data ORDER BY timestamp DESC LIMIT 1")
//    fun latestDrawing(): Flow<DrawingData>
//
//    @Query("SELECT * FROM drawing_data ORDER BY timestamp DESC")
